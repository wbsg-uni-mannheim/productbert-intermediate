...
for file in glob.glob('../../../data/processed/wdc-lspc/magellan/learning-curve/formatted/*'):
    if 'computers_trainonly_small' in file and 'metadata' not in file and '_pairs_' in file:
        ...
        pred_set = ['../../../data/processed/wdc-lspc/magellan/learning-curve/formatted/preprocessed_computers_gs_magellan_pairs_formatted.csv']
